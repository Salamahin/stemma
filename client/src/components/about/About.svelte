            ...
            <div class="modal-body">
                ...
                <div class="mt-4">
                    ...
                    <ul>
                        ...
                        <li>Если у выбранных родителей уже есть дети, то вместо создания новой семьи будет обновлена уже существующая</li>
                ...
                <div class="mt-4">
                    ...
                    <p>
                        <b
                            >Внимание, аутентификация в системе возможна только с помощью google-аккаунта. Это значит, что для приглашения пользователя
                            необходимо указывать его email, ассоциированный с google-аккаунтом</b>. Обычно, это gmail-почта, которая заканчивается на <i>@gmail.com</i>
                    </p>
                </div>
                <div class="mt-4">
