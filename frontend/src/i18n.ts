...
export const en: Record<string, string> = {
    ...
    'v2.tipPersonHasSpouse': '{name} has a spouse',
    'v2.tipPersonHasParents': '{name} has parents',
    'v2.tipParentHasChildren': '{name} has children',
    'v2.tipParentsHaveChildren': '{names} have children',
    'v2.tipChildHasParent': '{name} has a parent',
    'v2.tipChildrenHaveParent': '{names} have a parent',
    'v2.tipIsSpouse': "{person} is {family}'s spouse",
    'v2.tipIsChild': "{person} is {family}'s child",
    'v2.tipIsParent': "{person} is {names}'s parent",
    'v2.namesJoin': ' and ',
    'v2.namesSeparator': ', ',
    'v2.createSpouseTitleOf': "Add {name}'s spouse",
    'v2.createChildTitleOf': 'Add child of {names}',
...
export const ru: Record<string, string> = {
    ...
    'v2.tipPersonHasSpouse': 'у {name} есть супруг',
    'v2.tipPersonHasParents': 'у {name} есть родители',
    'v2.tipParentHasChildren': 'у {name} есть дети',
    'v2.tipParentsHaveChildren': 'у {names} есть дети',
    'v2.tipChildHasParent': 'у {name} есть родитель',
    'v2.tipChildrenHaveParent': 'у {names} есть родитель',
    'v2.tipIsSpouse': '{person} — супруг {family}',
    'v2.tipIsChild': '{person} — ребёнок {family}',
    'v2.tipIsParent': '{person} — родитель {names}',
    'v2.namesJoin': ' и ',
    'v2.namesSeparator': ', ',
    'v2.createSpouseTitleOf': 'Добавить супруга {name}',
    'v2.createChildTitleOf': 'Добавить ребёнка {names}',
