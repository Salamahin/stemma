...
export const en: Record<string, string> = {
    ...
    'v2.familyGhostAddParent': 'Add parent',
    ...
    'v2.shareGenerate': 'Generate link',
    'v2.shareLinkTitle': 'Invitation link ready',
    'v2.shareLinkHint': 'Send this link to the invited person',
...
export const ru: Record<string, string> = {
    ...
    'v2.familyGhostAddParent': 'Добавить родителя',
    ...
    'v2.shareGenerate': 'Создать ссылку',
    'v2.shareLinkTitle': 'Ссылка-приглашение готова',
    'v2.shareLinkHint': 'Отправьте эту ссылку приглашённому человеку',
