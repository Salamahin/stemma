    ...
    {#if open}
        <div class="tray-body">
            ...
            <button
                ...
                data-testid="v2-tray-add-all"
            >
                {$t("v2.tray.addAll")}
            </button>
            <div class="tray-chips" data-testid="v2-tray-chips">
                {#each orphans as person (person.id)}
                    <div
                        ...
                        data-testid={`v2-tray-chip-${person.id}`}
