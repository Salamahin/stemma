...
<Modal {open} title={$t("settings.title")} size="sm" onclose={close} testid="settings-modal">
    {#snippet body()}
    ...
    {#snippet footer()}
        ...
        <button type="button" class="btn btn-primary" onclick={save} data-testid="settings-save">{$t("common.save")}</button>
    {/snippet}
</Modal>
