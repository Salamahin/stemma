    ...
    {#if dropdownOpen}
        <div class="stemma-dropdown" data-testid="chip-dropdown">
                ...
                >
                    ...
                    >
                        <button
                            type="button"
                            class="row-btn"
                            aria-label={$t("renameStemma")}
                            title={$t("renameStemma")}
                            onclick={(e) => trigger(onstemmaRename, s, e)}
                            data-testid="chip-rename"
                        ><i class="bi bi-pencil"></i></button>
                        <button
                            type="button"
                            class="row-btn"
                            aria-label={$t("cloneStemma")}
                            title={$t("cloneStemma")}
                            onclick={(e) => trigger(onstemmaClone, s, e)}
                            data-testid="chip-clone"
                        ><i class="bi bi-copy"></i></button>
                        {#if s.removable}
                            <button
                                type="button"
                                class="row-btn danger"
                                aria-label={$t("deleteStemma")}
                                title={$t("deleteStemma")}
            ...
            <button
                ...
                class="add-stemma"
                onclick={addNew}
                data-testid="chip-add-stemma"
            >
                <i class="bi bi-plus-lg"></i> {$t("newStemma")}
            </button>
        </div>
    {/if}
</div>
