...
<div class="ghost-menu" data-testid="person-ghost-menu">
    {#if stage === "pick"}
        <button
            type="button"
            class="btn btn-outline-primary btn-sm role-btn"
            onclick={() => pick("addChild")}
            data-testid="person-ghost-add-child"
        >
            {$t("familyGhostAddChild")}
        </button>
        <button
            type="button"
            class="btn btn-outline-primary btn-sm role-btn"
            onclick={() => pick("addSpouse")}
            data-testid="person-ghost-add-spouse"
        >
            {$t("familyGhostAddSpouse")}
        </button>
        <button
            type="button"
    ...
    {:else}
        ...
        <div class="actions">
            ...
            <button
                ...
                disabled={!name.trim()}
                onclick={confirm}
                data-testid="person-ghost-confirm"
            >
                {$t("common.add")}
            </button>
        </div>
