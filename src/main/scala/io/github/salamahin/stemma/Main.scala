...
//    .zServerLogic(_ => service.flatMap(_.stemma()))
//    .widen[STEMMA_ENV]
//
...
//    .out(customJsonBody[Family])
//    .errorOut(customJsonBody[StemmaError])
//    .zServerLogic { case (id, family) => service.flatMap(_.updateFamily(id, family)) }
//    .widen[STEMMA_ENV]
//
...
//    .out(emptyOutput)
//    .errorOut(customJsonBody[StemmaError])
//    .zServerLogic(id => service.flatMap(_.removeFamily(id)))
//    .widen[STEMMA_ENV]
//
...
//    .errorOut(customJsonBody[StemmaError])
//    .zServerLogic { case (id, person) => service.flatMap(_.updatePerson(id, person)) }
//    .widen[STEMMA_ENV]
//
...
//    .out(emptyOutput)
//    .errorOut(customJsonBody[StemmaError])
//    .zServerLogic(id => service.flatMap(_.removePerson(id)))
//    .widen[STEMMA_ENV]
//
